...
public final class FragmentDraftsBinding implements ViewBinding {
  ...
  private FragmentDraftsBinding(@NonNull FrameLayout rootView, @NonNull RecyclerView recyclerView) {
  ...
  public static FragmentDraftsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentDraftsBinding((FrameLayout) rootView, recyclerView);
    }
